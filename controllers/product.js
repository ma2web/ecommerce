...
module.exports = {
  ...
  addComment: async (req, res) => {
    ...
    if (req.body.rating > 5 || req.body.rating < 0)
      return res.status(404).send({message: "wrong rating input (0 ~ 5)"});
  ...
  addCategoryToProduct: async (req, res) => {
    ...
    if (!_category) return res.status(404).send({message: "category not found"});
  ...
  addTag: async (req, res) => {
    ...
    await product.save();
    res.send({message: "tag has been added"});
  },
  removeTag: async (req, res) => {
    ...
    await product.save();
    res.send({message: "tag has been removed"});
  },
  addSize: async (req, res) => {
    ...
    await product.save();
    res.send({message: "size has been added"});
  },
  removeSize: async (req, res) => {
    ...
    product = await product.save();
    res.send({message: "size has been removed"});
  },
